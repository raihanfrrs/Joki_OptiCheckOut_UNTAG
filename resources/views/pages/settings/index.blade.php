    ...
    <div class="row fv-plugins-icon-container">
      <div class="col-md-12">
        <ul class="nav nav-pills flex-column flex-md-row mb-4">
          <li class="nav-item">
            <a class="nav-link {{ request()->is('settings/profile') ? 'active' : '' }}" href="{{ route('settings.profile') }}"><i class="ti-xs ti ti-users me-1"></i> Profil</a>
          </li>
          <li class="nav-item">
            <a class="nav-link {{ request()->is('settings/account') ? 'active' : '' }}" href="{{ route('settings.account') }}"><i class="ti-xs ti ti-lock me-1"></i> Akun</a>
          </li>
        </ul>
