      ...
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          ...
          <div class="text-center mb-4">
            <h3 class="mb-2">Ubah Informasi Produk</h3>
          </div>
          <div id="data-edit-product-modal"></div>
        </div>
      </div>
    </div>
</div>

<div class="modal fade" id="editInventoryProduct" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-simple modal-edit-user">
      <div class="modal-content p-3 p-md-5">
        <div class="modal-body">
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          <div class="text-center mb-4">
            <h3 class="mb-2">Ubah Informasi Persediaan Produk</h3>
          </div>
          <div id="data-edit-inventory-product-modal"></div>
        </div>
      </div>
    </div>
</div>
